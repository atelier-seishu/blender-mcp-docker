...
from scripts.tripo_wrapper import run_tripo_sr  # TripoSR実行ラッパーを使用

# ディレクトリ構成
INPUT_DIR = "data/input"
OUTPUT_DIR = "data/output"
TMP_DIR = "data/tmp"
BLENDER_MCP_SCRIPT = "blender_mcp/run_mcp.py"
...
def generate_mesh(input_image_path, output_mesh_path):
    ...
    # run_tripo_sr に出力先フォルダを渡す（ファイル名は mesh.obj 固定）
...
def run_blender_mcp(input_mesh_path, output_dir):
    ...
    result = subprocess.run([
        "/usr/bin/blender", "--background", "--python", BLENDER_MCP_SCRIPT, "--",
